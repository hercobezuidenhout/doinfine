...
export const EmailSettings = ({ scope }: EmailSettingsProps) => {
    ...
    return (
        <SettingsTemplate title="Email">
            <Text>
                Doinfine uses <Link href="https://resend.com/home" color="chakra-primary-color">Resend</Link> to send emails.
                For Doinfine to stay free of charge, <strong>the Resend details need to be supplied by you</strong>.
                To configure the Resend details for your team, reach out to the Doinfine team.
            </Text>
            <Text>

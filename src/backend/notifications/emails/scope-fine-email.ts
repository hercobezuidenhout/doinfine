...
export const scopeFineEmail = ({ issuedToName, issuedByName, description, link }: FineEmail) =>
    `
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <main>
        <div class="heading roboto-bold">
            ...
            <div class="text">
                <h4>Oh no</h4>
                <h1>${issuedToName} has been fined!</h1>
            </div>
        </div>
        <div class="details roboto-light">
            <p>${issuedByName} has fined ${issuedToName} for</p>
            <h3>"${description}"</h3>
        </div>

...
export const scopeWinEmail = ({ issuedToName, issuedByName, description, link }: WinEmail) =>
    `
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <main>
        <div class="heading roboto-bold">
            ...
            <div class="text">
                <h4>Horray!</h4>
                <h1>There is another win!</h1>
            </div>
        </div>
        <div class="details roboto-light">
            <p>${issuedByName} has awarded ${issuedToName} a win for</p>
            <h3>"${description}"</h3>
        </div>

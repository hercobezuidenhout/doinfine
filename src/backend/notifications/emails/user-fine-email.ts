...
export const userFineEmail = ({ issuedToName, issuedByName, description, link }: FineEmail) =>
    `
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <main>
        <div class="heading roboto-bold">
            <span>🚨</span>
            <div class="text">
                <h4>Oh no, ${issuedToName}</h4>
                <h1>You've been fined!</h1>
            </div>
        </div>
        <div class="details roboto-light">
            <p>${issuedByName} has fined you for</p>
            <h3>"${description}"</h3>
        </div>
